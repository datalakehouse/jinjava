...
public class TodayEnhancedFunctionTest extends BaseInterpretingTest {
  ...
  public void testTodayWithNegativeOffsetShorthand() {
    ...
    ZonedDateTime expected = LocalDate
      .now(ZoneOffset.UTC)
      .minusDays(10)
  ...
  public void testTodayWithBadTimezoneAndPositiveOffset() {
    // Test: today("utc", 5) but 'utc' is not a valid timezone, only 'Z' is for UTC
    // so, it should fail
